...
export const SIDEBAR_LINKS = [
  { type: 'link', path: 'Home', icon: HomeIcon, activeIcon: HomeIconFilled, label: 'Home', labelKey: 'sidebar_home' },
  { type: 'link', path: 'Explore', icon: SearchIcon, activeIcon: SearchIcon, label: 'Explore', labelKey: 'sidebar_explore' },
  { type: 'link', path: 'Videos', icon: VideoIcon, activeIcon: VideoIconFilled, label: 'Reels', labelKey: 'sidebar_videos' },
  { type: 'link', path: 'Messages', icon: MailIcon, activeIcon: MailIconFilled, label: 'Messages', labelKey: 'sidebar_messages' },
  { type: 'link', path: 'Notifications', icon: NotificationsIcon, activeIcon: NotificationsIconFilled, label: 'Notifications', labelKey: 'sidebar_notifications' },
  { type: 'link', path: 'Profile', icon: ProfileIcon, activeIcon: ProfileIconFilled, label: 'Profile', labelKey: 'sidebar_profile' },
  
  { type: 'divider' },

  { type: 'link', path: 'Bookmarks', icon: BookmarkIcon, activeIcon: BookmarkedIcon, label: 'Saved', labelKey: 'sidebar_bookmarks' },
